...
function RegisterPage() {
    ...
    const googleUrl = `${("TURBOPACK compile-time value", "http://localhost:4000")}/api/auth/google`;
    const submit = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/auth/register', {
                email,
                password
            });
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveToken"])(res.data.token);
            router.replace('/');
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d823344._.js.map