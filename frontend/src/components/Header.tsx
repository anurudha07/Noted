    ...
    <header className="w-full p-3 flex items-center justify-end border-b border-gray-800">
      <div className="flex items-center gap-3">
        <div className="relative" ref={appRef}>
          ...
          {appOpen && (
            <div className="absolute right-0 mt-3.5px w-38 h-32  bg-black border border-gray-800 shadow-lg z-45 ">
              <div className="p-2">
        ...
        <div className="relative" ref={profileRef}>
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-3.5px w-56 bg-black border border-gray-800 shadow-lg z-50 ">
              <div className="p-3">
                <div className="flex items-center gap-3">
